    ...
    <header className="relative w-full h-[400px] lg:h-[500px] overflow-hidden">
      ...
      {mobileOpen && (
        <div className="absolute inset-0 bg-white text-black z-40 py-10 px-6 flex flex-col gap-6">
          ...
          <Link href="/home" onClick={() => setMobileOpen(false)} className="text-lg font-semibold">Home</Link>
      ...
      >
        <motion.p
          ...
          transition={{ duration: 0.6 }}
        >
          <Link href="/" className="text-orange-400 hover:underline">Home</Link> &gt;&gt; <span className="text-white">Gallery</span>
        </motion.p>
        <motion.h1
